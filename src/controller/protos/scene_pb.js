...
proto.Mat4.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.Vec4.serializeBinaryToWriter
    );
  }
  f = message.getY();
  if (f != null) {
...
proto.Mat4.prototype.getX = function() {
  return /** @type{?proto.Vec4} */ (
    jspb.Message.getWrapperField(this, proto.Vec4, 1));
};
...
proto.Mat4.prototype.getY = function() {
  return /** @type{?proto.Vec4} */ (
    jspb.Message.getWrapperField(this, proto.Vec4, 2));
};
...
proto.Mat4.prototype.getZ = function() {
  return /** @type{?proto.Vec4} */ (
    jspb.Message.getWrapperField(this, proto.Vec4, 3));
};
...
proto.Mat4.prototype.getW = function() {
  return /** @type{?proto.Vec4} */ (
    jspb.Message.getWrapperField(this, proto.Vec4, 4));
};
...
proto.BufferView.prototype.getTarget = function() {
  return /** @type {!proto.BufferTarget} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
...
proto.MeshPrimitive.prototype.getMode = function() {
  return /** @type {!proto.MeshPrimitiveMode} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
...
proto.Mesh.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.MeshPrimitive.toObject, includeInstance)
  };
...
proto.Mesh.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,proto.MeshPrimitive.deserializeBinaryFromReader);
...
proto.Mesh.prototype.getPrimitivesList = function() {
  return /** @type{!Array<!proto.MeshPrimitive>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.MeshPrimitive, 1));
};
...
proto.Mesh.prototype.addPrimitives = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.MeshPrimitive, opt_index);
};
...
proto.Node.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    matrix: (f = msg.getMatrix()) && proto.Mat4.toObject(includeInstance, f),
    rotation: (f = msg.getRotation()) && proto.Vec4.toObject(includeInstance, f),
    scale: (f = msg.getScale()) && proto.Vec3.toObject(includeInstance, f),
    translation: (f = msg.getTranslation()) && proto.Vec3.toObject(includeInstance, f)
  };
...
proto.Node.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.Mat4.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.Vec3.serializeBinaryToWriter
    );
  }
...
proto.Node.prototype.getMesh = function() {
  return /** @type{?proto.Mesh} */ (
    jspb.Message.getWrapperField(this, proto.Mesh, 2));
};
...
proto.Node.prototype.getMatrix = function() {
  return /** @type{?proto.Mat4} */ (
    jspb.Message.getWrapperField(this, proto.Mat4, 3));
};
...
proto.Node.prototype.getScale = function() {
  return /** @type{?proto.Vec3} */ (
    jspb.Message.getWrapperField(this, proto.Vec3, 5));
};
...
proto.Node.prototype.getTranslation = function() {
  return /** @type{?proto.Vec3} */ (
    jspb.Message.getWrapperField(this, proto.Vec3, 6));
};
...
proto.Scene = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.Scene.repeatedFields_, null);
};
...
proto.Scene.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.Buffer.toObject, includeInstance),
    bufferviewsList: jspb.Message.toObjectList(msg.getBufferviewsList(),
    proto.BufferView.toObject, includeInstance),
...
proto.Scene.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.BufferView.serializeBinaryToWriter
    );
  }
...
proto.Scene.prototype.getBuffersList = function() {
  return /** @type{!Array<!proto.Buffer>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Buffer, 1));
};
...
proto.Scene.prototype.addBuffers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Buffer, opt_index);
};
...
proto.Scene.prototype.getBufferviewsList = function() {
  return /** @type{!Array<!proto.BufferView>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.BufferView, 2));
};
...
proto.Scene.prototype.addBufferviews = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.BufferView, opt_index);
};
...
proto.Scene.prototype.getMeshesList = function() {
  return /** @type{!Array<!proto.Mesh>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Mesh, 3));
};
...
proto.Scene.prototype.addMeshes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.Mesh, opt_index);
};
...
proto.Scene.prototype.getRootnode = function() {
  return /** @type{?proto.Node} */ (
    jspb.Message.getWrapperField(this, proto.Node, 4));
};
